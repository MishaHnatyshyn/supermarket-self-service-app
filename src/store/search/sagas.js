import {
  all, takeLatest, select, call, put, delay,
} from 'redux-saga/effects';
import {
  changeCurrentPage, fetchSearchStart, fetchSearchError, fetchSearchSuccess,
} from './actions';
import {
  getAppliedFilters, getCurrentPage,
  getLoadedProductsCount, getNextPage, getPageSize, getPrevPage, getSearchInputValue,
} from './selectors';
import { get } from '../../utils/http';
import { SEARCH_API_URL, SEARCH_DEBOUNCE_TIME_IN_MS } from '../../utils/config';
import {
  CHANGE_SEARCH_INPUT, FETCH_NEXT_PAGE, FETCH_PREV_PAGE, PERFORM_SEARCH,
} from './actionTypes';
