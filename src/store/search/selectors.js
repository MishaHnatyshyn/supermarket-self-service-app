...
export const getPaging = compose(
  prop('paging'),
  root,
);

export const getSearchInputValue = compose(
  prop('searchInput'),
  root,
);
...
export const getAvailableFilters = compose(
  prop('availableFilters'),
  root,
);
...
export const getLoadedProductsCount = compose(
  prop('length'),
  getProducts,
);
...
export const getTotalPages = compose(
  prop('totalPages'),
  getPaging,
);
